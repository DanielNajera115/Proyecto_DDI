...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        public CommandDecoder commandDecoder;
...
//                        ResultsField.text = text;
                        if(res.final){
                           // commandDecoder.DecodeString(alt.transcript);
                            //commandDecoder.DecodeString("c 3");
                            //commandDecoder.DecodeString("b 8");
                            //commandDecoder.DecodeString("c 6");
                            
                            //commandDecoder.DecodeString("caballo d 5 f 6");
                        }
                    }
